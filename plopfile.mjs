    ...
    actions: [
      ...
      (answers) =>
        [
          ...
          "  4. Author the page and demos. Add the title, RSC status and demo files to apps/docs/test/fixtures/component-inventory.json.",
          ...
          "  7. Add source-contracts.test.ts entries and public type/API checks.",
          "  8. pnpm ci:checks",
        ].join("\n"),
    ],
  });
