...
// Themable role tokens from docs/spec/theming.md §2.2. Library source may use these only.
...
// Exact reviewed allowlist from tooling.md §5.2 — class-exact, not path-wide.
