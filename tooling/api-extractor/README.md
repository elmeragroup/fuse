...
file carries an `oxlint-disable` header. Every exception is at the line it governs — an
...
rather than carrying it — 26 rule-instances were being carried that way. _(Amended 2026-09-03.)_
