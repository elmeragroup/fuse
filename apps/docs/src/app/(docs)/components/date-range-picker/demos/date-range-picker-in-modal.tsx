 ...
 * longer carries an overlay-container attribute of its own (date-picker.md §6,
 * 2026-09-03); the regression is pinned by the DateRangePicker browser suite, on this
