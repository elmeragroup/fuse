...
const docsCodeBlock = tv({
  base: "bg-docs-code font-docs-mono overflow-x-auto text-[12px] leading-[1.65] [tab-size:2] text-[var(--sh-identifier,_var(--docs-ink))] [&_.sh__line]:block [&_.sh__line]:min-h-[1lh] [&_code]:block [&_code]:min-w-max [&_code]:border-0 [&_code]:p-0 [&_code]:[background:none] [&_code]:[font:inherit]",
  variants: {
    variant: {
