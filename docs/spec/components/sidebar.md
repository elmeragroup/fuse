...
| `Sidebar.Rail`                      | `button`                                                               | invisible `w-4` (16 px) grab strip on the sidebar edge, painting a 2 px hover line (`after:w-[2px]`, `hover:after:bg-sidebar-border`); `sm:` and up only; click toggles; `tabIndex={-1}` + `aria-hidden`, localized `title`; direction-aware resize cursors _(Amended 2026-09-03 — the strip was described as 4 px; `w-4` is 16 px and the 2 px measure is the hover line.)_ |
