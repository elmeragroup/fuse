...
Normative chapter for `@elmeragroup/ui`. Every component follows these library-wide accessibility rules and tests its own keyboard, label, and focus behavior.
