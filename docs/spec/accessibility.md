...
Normative chapter for `@elmeragroup/ui`. Every component spec's §7 (Accessibility) is read against these library-wide rules; this chapter states what no per-component spec repeats.
