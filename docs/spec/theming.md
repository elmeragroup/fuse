...
Normative chapter for `@elmeragroup/ui`: the token contract, the cascade mechanism, the complete value matrix for all 20 themes, the theme provider API, and the token pipeline.
