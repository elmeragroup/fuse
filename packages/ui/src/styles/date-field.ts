 ...
 * `size` axis. The `input` slot itself reads `--control-px-md` and the control type pair
 * so the segmented row matches Input at both densities; `py-*` stays off the height-pinned
 * box.
 *
