...
import type * as LinkApi from "@elmeragroup/ui/react-aria/link";
import type { LinkProps } from "@elmeragroup/ui/react-aria/link";
...
test("there is no bare link entry", () => {
  ...
  type _Bare = typeof import("@elmeragroup/ui/link");
});
