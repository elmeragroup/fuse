...
import type * as GridListApi from "@elmeragroup/ui/react-aria/grid-list";
import type { GridListItemProps, GridListProps } from "@elmeragroup/ui/react-aria/grid-list";
...
test("there is no bare grid-list entry", () => {
  ...
  type _Bare = typeof import("@elmeragroup/ui/grid-list");
});
