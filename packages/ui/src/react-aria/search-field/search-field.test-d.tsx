...
import type * as SearchFieldApi from "@elmeragroup/ui/react-aria/search-field";
import type { SearchFieldProps } from "@elmeragroup/ui/react-aria/search-field";
...
test("there is no bare search-field entry", () => {
  ...
  type _Bare = typeof import("@elmeragroup/ui/search-field");
});
