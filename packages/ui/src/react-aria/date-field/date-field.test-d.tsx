...
import type * as DateFieldApi from "@elmeragroup/ui/react-aria/date-field";
import type { DateFieldProps, DateInputProps } from "@elmeragroup/ui/react-aria/date-field";
import { DateField, DateInput } from "@elmeragroup/ui/react-aria/date-field";
...
test("there is no bare date-field entry", () => {
  ...
  type _Bare = typeof import("@elmeragroup/ui/date-field");
});
