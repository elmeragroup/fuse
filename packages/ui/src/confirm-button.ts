// Source entry facade for `@elmeragroup/ui/confirm-button` (Appendix A). Pure re-export file:
...
// or src/index.ts.
export { ConfirmButton } from "./components/confirm-button/confirm-button";
