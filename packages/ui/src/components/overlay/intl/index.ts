 ...
 * shared `OverlayCloseButton` (Dialog.Content's corner affordance and Sidebar's
 * mobile header row), `dialog.tsx`'s footer action (where the label is also visible
 * text), `toast.tsx`, and the package-private `react-aria/internal/dialog.tsx`. The
