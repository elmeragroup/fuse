...
import type { ConfirmButton as RootConfirmButton } from "@elmeragroup/ui";
import type { ConfirmButtonProps } from "@elmeragroup/ui/confirm-button";
import * as ConfirmButtonModule from "@elmeragroup/ui/confirm-button";
...
test("the element takes Button props except onClick, and onConfirm is required", () => {
  ...
  const _iconMissing = <ConfirmButton size="icon" onConfirm={() => undefined} />;
