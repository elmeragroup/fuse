// Source entry facade for `@elmeragroup/fuse/phone-number-field` (Appendix A). Pure re-export file:
...
// or src/index.ts. No public recipe — layout comes from FieldFrame.
