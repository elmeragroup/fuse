...
export const calendarVariants = tv({
  slots: {
    base: "max-w-sm text-sm shadow-md min-h-80 min-w-32 rounded-[--theme(--radius-fixed)] border border-border bg-card bg-clip-padding p-2 text-card-foreground will-change-transform",
