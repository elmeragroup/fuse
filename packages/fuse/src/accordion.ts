// Source entry facade for `@elmeragroup/fuse/accordion` (Appendix A). Pure re-export file:
...
export { accordionVariants } from "./components/accordion/accordion-variants";
